...
<body class= "container mt-5" >
    ...
    <center>
       <form class= "custom-form"action="{{ route('customer.store') }}" method="POST">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="customer_name" id="customer_name"  required>
           ...
           <div class="form-group">
               ...
               <input type="text" class="form-control" name="customer_code" id="customer_code"  value="{{ $customer }}" readonly>
           </div>
