...
<a href = "{{ route('product.index') }}" class="btn btn-primary mt-5">BACK</a>
...
<div class="container mt-5">
    <form class="custom-form">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="product_name" id="product_name" value="{{ $product->product_name }}" readonly>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="discount_percentage" id="discount_percentage" value="{{ $product->discount}}" readonly>
        </div>


        <div class="form-group">
            <label for="datePickerFrom">EXPIRY DATE</label>
            <input type="date" class="form-control" name="expiry_date"  value="{{ $product->expiry_date }}"  readonly>
        </div>
